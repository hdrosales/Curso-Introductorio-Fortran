MODULE sobrecarga
    implicit none
    !---
    !Dentro del bloque interface, module procedure concatena indica que la 
    !implementación del operador + para el tipo de datos definido se realiza 
    !mediante la función concatena en el módulo.
    interface operator (+)
